...
リーダーを担当した。行なったことを下記に示す
1. プロジェクトのREADE.mdを記述する
<br>システムの動作確認方法や使用するライブラリ、バージョンなどをまとめた。
2. ワークツリーの構造の決定
<br>どのようなディレクトリの構造で、どこにファイルを置くべきかを決定し、それに沿うようにメンバーに伝えた。
3. 質疑応答と作業のサポート
<br>プログラムの構造における不明点やエラーの原因などの質問に対応した。
<br>watchdogの作業のサポートを行なった。サンプルプログラムの解読、説明など
4. プルリクエスト対応
<br>プルリクエストがあった場合、fetchしてからマージ対象ブランチに切り替え、動作の確認を行なってからマージをした。

## 3. チーム作業のログ
<pre>
* commit fd5ac41503863040393900f02f7856ea85401926 (HEAD -> k20066, origin/k20066)
| Author: 鈴木涼介 <87357429+RyosukeSuzukii@users.noreply.github.com>
| Date:   Wed Dec 22 22:42:34 2021 +0900
| 
|     Update README.md
|   
*   commit 1353e96385716f8f607461b7832c194796fef2a6 (origin/main, origin/HEAD, main)
|\  Merge: 0d44ff8 9cd1573
| | Author: Natchan5150 <k19234kk@aitech.ac.jp>
| | Date:   Wed Dec 22 20:30:59 2021 +0900
| | 
| |     Update .DS_Store
| |   
| *   commit 9cd1573e831a7ca7d870d3ef98ee8737904e7290
...
| |       imgフォルダの整理も少し行った
| | 
* | commit 0d44ff8dd0609dbbf4c3d78d2a9ab6f815602e56
|/  Author: Natchan5150 <k19234kk@aitech.ac.jp>
|   Date:   Wed Dec 22 19:37:32 2021 +0900
|   
|       Update .DS_Store
|   
*   commit 59ea44e8cde002bb6d4da091f0a3bc3ae2f5e99d (integrate)
...
| |      一連の流れを連結させました。
| | 
| * commit c8de30b481df3b6d6f12960ddc21bd581f79211c (origin/margeTestFrom_web_k20127)
| | Author: わだたける <wdtkru@icloud.com>
...
| | 
| * commit 38dc74c21101213b54b1bccd61ee52d59004fd74 (margeTestFrom_web_k20127)
| | Author: わだたける <wdtkru@icloud.com>
...
| | | | 
| * | | commit 5120fe13727ea4c3a0d64c3fac26c60308d2e18c (origin/nagisa-gray, nagisa-gray)
| | | | Author: nagitonsama <95839502+nagitonsama@users.noreply.github.com>
...
| | | |     K20068
| | | | 
| * | | commit 6badb54e934e30e1ec237e54813ad266f67e798e (origin/k20068, k20068)
...
## 5. 感想
プルリクエストを対応するのが遅くなってしまい、チームメンバーにマージの対応をさせてしまった。
メンバー全員に作業箇所があり、各個人がその作業を達成できた。本番でも、作業する内容がない人を作らず、各個人に合わせた作業の難易度、作業量を割り振るよう尽力する。
